...
export default function Navigation({ links }: { links?: NavLink[] }) {
  ...
  return (
    <header className="top-0 z-50 bg-white text-black border-b mx-auto w-full border-gray-200 relative">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-3 items-center gap-4 h-12">
            ...
            <div className="flex items-center justify-end">
              ...
              <form
                onSubmit={onSearch}
                className="hidden md:flex items-center ml-4 translate-x-2"
              >
